    ...
    LazyColumn(
        ...
        item {
            ...
            Row(verticalAlignment = Alignment.CenterVertically) {
                ...
                Text("Нова звичка", style = MaterialTheme.typography.titleMedium, fontWeight = FontWeight.Bold)
            }
        }
        ...
        item {
            Box(
                ...
                Box(
                    ...
                    Text(habitIcon(state.selectedIconKey), style = MaterialTheme.typography.titleLarge)
                }
            }
        }
            ...
            LazyVerticalGrid(
                ...
                items(iconKeys) { key ->
                    ...
                    Box(
                        ...
                        Text(habitIcon(key), color = TextPrimary)
                    }
                }
            }
        }
        ...
        item {
            ...
            Button(
                ...
                Text("Створити звичку ✓", fontWeight = FontWeight.Bold)
            }
